                            ...
                            if(child.Success)
                            {
                                ...
                                using (var family = ImRaii.Child("##Family", new Vector2(200.0f, 150.0f), true))
                                {
                                    if (family.Success)
                                    {
                                        ...
                                        if (showFamilyPopup)
                                        {
                                            ...
                                            var popup = ImRaii.PopupModal("NouveauMembre", ref showFamilyPopup, ImGuiWindowFlags.AlwaysAutoResize);
                                            if(popup.Success)
                                            {
                                ...
                                using (var friends = ImRaii.Child("##Friends", new Vector2(200.0f, 150.0f), true))
                                {
                                    if(friends.Success)
                                    {
                                        ...
                                        if (showFriendsPopup)
                                        {
                                            var popup = ImRaii.PopupModal("NouvelAmi", ref showFriendsPopup, ImGuiWindowFlags.AlwaysAutoResize);
                                            if (popup.Success)
                                            {
                                ...
                                using (var enemies = ImRaii.Child("##Enemies", new Vector2(200.0f, 150.0f), true))
                                {
                                    if(enemies.Success)
                                    {
                                        ...
                                        if (showEnemiesPopup)
                                        {
                                            var popup = ImRaii.PopupModal("NouvelEnnemi", ref showEnemiesPopup, ImGuiWindowFlags.AlwaysAutoResize);
                                            if (popup.Success)
                                            {
